...
class Redis
{
    ...
    public function getKeyPictureNameToId()
    {
        return "pictureName.to.id";
    }
    ...
    public function setPictureNameToId($pictureName,$id)
    {
        return $this->handler->hSet($this->getKeyPictureNameToId(),$pictureName,$id);
    }
